...
class Resource(BaseModel):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='resource_author')
    ...
    categories = models.ManyToManyField('account.Interest', related_name='resource_categories', blank=True)
...
class Post(BaseModel):
    ...
    attachments = models.ManyToManyField('resource.Attachment', related_name='post_attachments', blank=True)
    categories = models.ManyToManyField('account.Interest', related_name='post_categories', blank=True)
    audience = models.ForeignKey(Audience, on_delete=models.CASCADE)
